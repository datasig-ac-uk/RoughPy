...
//     return drivers::find(
//             range.buffer(),
//             devices::ConstReference(value.data(), value.type())
//     );
// }
//
// /**
...
//  */
// template <typename T>
// RPY_NO_DISCARD optional<dimn_t> find(const ScalarArray& range, const T&
// value)
// {
...
//  *
//  * This method returns an optional containing the index of the first element
//  in
//  * the range that is not less than the given value. If no such element is
//  found,
...
//  *
//  * @return An optional containing the index of the lower bound, if found. If
//  no
...
//
// /**
//  * @brief Find the first element in the ScalarArray range that is not less
//  than
//  * the given value.
//  *
//  * @param range The ScalarArray range to search in.
...
//  * given value. If the given value is greater than or equal to all elements
//  in
...
//  * @param value The value to search for.
//  *
//  * @return An optional containing the index of the upper bound, if found. If
//  the
...
//  * and returns an optional containing the index of the first mismatch if
//  found,
...
//  *
//  * This function swaps the elements between two ScalarArray ranges. The
//  ranges
//  * are specified by two ScalarArray references, `left` and `right`. The
//  elements
//  * within the ranges are swapped using the `swap_ranges` function defined in
//  the
//  * `drivers` namespace. Before swapping, this function checks if both `left`
//  and
//  * `right` ScalarArray objects have the same type using the `type` function.
//  If
...
//  *
//  * @note This function assumes that `left` and `right` ScalarArray objects
//  are
//  *       mutable.
//  */
...
//  *
//  * This method copies the contents of the source ScalarArray to the
//  destination
...
//  *
//  * @param dst The destination ScalarArray where the contents will be copied
//  to.
...
//  *
//  * This method reverses the order of the elements in the provided
//  ScalarArray.
//  *
...
//
//  This method fills a ScalarArray with a specified value. The value is passed
//  as a reference to a constant T object.
//
...
//     drivers::min(
//             range.buffer(),
//             devices::Reference(result.mut_pointer(),
//             result.type()->as_type())
//     );
//     return result;
// }
...
//  *
//  * This method calculates the maximum value within the given ScalarArray
//  range.
