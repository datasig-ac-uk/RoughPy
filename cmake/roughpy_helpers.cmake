...
function(add_roughpy_component _name)
    ...
    if (_runtime_deps)
        list(REMOVE_DUPLICATES _runtime_deps)
    ...
    if (ROUGHPY_LIBS)
        set(ROUGHPY_LIBS "${ROUGHPY_LIBS};${_ifc_alias_name}" CACHE INTERNAL "" FORCE)
    else ()
        set(ROUGHPY_LIBS "${_ifc_alias_name}" CACHE INTERNAL "" FORCE)
    endif ()
