...
#ifndef ROUGHPY_GENERICS_INTERNAL_POLYNOMIAL_CONVERSION_H
#define ROUGHPY_GENERICS_INTERNAL_POLYNOMIAL_CONVERSION_H
...
make_poly_conversion_to_table();

boost::container::flat_map<hash_t, std::unique_ptr<const ConversionFactory>>
make_poly_conversion_from_table();

}


#endif //ROUGHPY_GENERICS_INTERNAL_POLYNOMIAL_CONVERSION_H
