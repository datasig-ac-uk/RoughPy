...
class VectorAdditionTests : public ::testing::Test, public rpy::compute::testing::PolynomialTensorHelper
{
...
TEST_F(VectorAdditionTests, VectorAdditionIdentityOps)
{
    ...
    std::vector<Scalar> result(basis.size());
...
TEST_F(VectorAdditionTests, VectorAdditionIdentityLhsScaledRhs)
{
    auto basis = get_basis();
    ...
    basic::vector_addition(result_view,
                           lhs_view,
                           rhs_view,
                           ops::Identity{},
...
TEST_F(VectorAdditionTests, VectorAdditionScaledLhsIdentityRhs)
{
    auto basis = get_basis();
