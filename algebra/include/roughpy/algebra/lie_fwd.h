...
class RPY_EXPORT LieBundleInterface : public BundleInterface<LieBundle, Lie, Lie>
{
...
RPY_SERIAL_SPECIALIZE_TYPES(rpy::algebra::LieInterface, rpy::serial::specialization::member_serialize);
RPY_SERIAL_SPECIALIZE_TYPES(rpy::algebra::Lie, rpy::serial::specialization::member_serialize)
RPY_SERIAL_SPECIALIZE_TYPES(rpy::algebra::LieBundleInterface, rpy::serial::specialization::member_serialize);
