...
#ifndef ROUGHPY_SCALAR_IMPLEMENTATIONS_BFLOAT_16_TYPE_H
#define ROUGHPY_SCALAR_IMPLEMENTATIONS_BFLOAT_16_TYPE_H
...
class BFloat16Type : public devices::Type{
    BFloat16Type();
public:
...
#endif //ROUGHPY_SCALAR_IMPLEMENTATIONS_BFLOAT_16_TYPE_H
