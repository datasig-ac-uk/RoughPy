...
#ifndef ROUGHPY_SCALAR_IMPLEMENTATIONS_POLY_RATIONAL_H
#define ROUGHPY_SCALAR_IMPLEMENTATIONS_POLY_RATIONAL_H
...
class RPY_LOCAL Polynomial : public platform::SmallObjectBase
{
...
private:
    template <typename F>
    RPY_LOCAL void inplace_transform(F&& func);
...
#endif// ROUGHPY_SCALAR_IMPLEMENTATIONS_POLY_RATIONAL_H
