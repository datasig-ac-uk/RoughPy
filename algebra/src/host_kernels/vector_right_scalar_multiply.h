...
extern template class VectorUnaryWithScalarOperator<rpy::devices::operators::RightScalarMultiply, float>;
extern template class VectorUnaryWithScalarOperator<rpy::devices::operators::RightScalarMultiply, double>;
