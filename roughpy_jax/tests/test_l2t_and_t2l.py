...
def test_l2t_t2l_scaled_roundtrip(rpy_dtype, rpy_batch):
    lie_basis = rpj.LieBasis(4, 4)
    tensor_basis = rpj.TensorBasis(lie_basis.width, lie_basis.depth)
